...
const SharedTodosPage = () => {
    ...
    const loadSharedTodos = async () => {
        try {
            ...
            setError('Kunne ikke laste delte oppgaver. Pr�v igjen senere.');
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleUpdate = async (todoId, updatedData) => {
        try {
            ...
            setError('Kunne ikke oppdatere oppgaven. Pr�v igjen senere.');
        }
    };
    ...
    const handleDelete = async (todoId) => {
        try {
            ...
            setError('Kunne ikke slette oppgaven. Pr�v igjen senere.');
        }
    };
